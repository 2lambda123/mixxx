...
PioneerCDJ850.reverse_toggle = function(channel, control, value, status, group) {
    if (value == 0) { return; }
    if (PioneerCDJ850.reverse_play) { PioneerCDJ850.reverse_play = false; } else { PioneerCDJ850.reverse_play = true; }
...
PioneerCDJ850.hotcue_last_delete = function(channel, control, value, status, group) {
    if (PioneerCDJ850.last_hotcue < 1 || PioneerCDJ850.last_hotcue > 4) { return; }
