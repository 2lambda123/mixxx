var NovationLaunchpad = (function() {
    ...
    const freeGlobal = (typeof global === "undefined" ? "undefined" : _typeof(global)) == "object" && global && global.Object === Object && global;

    /** Detect free variable `self`. */

    const freeSelf = (typeof self === "undefined" ? "undefined" : _typeof(self)) == "object" && self && self.Object === Object && self;
    ...
    const reIsNative = RegExp("^" + funcToString$1.call(hasOwnProperty$1).replace(reRegExpChar, "\\$&")
    ...
    const hasOwnProperty$3 = objectProto$5.hasOwnProperty;
    /** Built-in value references. */
    ...
    const freeExports = (typeof exports === "undefined" ? "undefined" : _typeof(exports)) == "object" && exports && !exports.nodeType && exports;
    /** Detect free variable `module`. */

    const freeModule = freeExports && (typeof module === "undefined" ? "undefined" : _typeof(module)) == "object" && module && !module.nodeType && module;
    ...
    const freeExports$1 = (typeof exports === "undefined" ? "undefined" : _typeof(exports)) == "object" && exports && !exports.nodeType && exports;
    /** Detect free variable `module`. */

    const freeModule$1 = freeExports$1 && (typeof module === "undefined" ? "undefined" : _typeof(module)) == "object" && module && !module.nodeType && module;
    /** Detect the popular CommonJS extension `module.exports`. */
    ...
    const Control = /*#__PURE__*/function() {
        /**
         * @param def
         */
    ...
    const playListControl = Object.keys(playListControlDef).reduce(function(obj, key) {
        return assign(obj, _defineProperty$1({}, key, new Control(playListControlDef[key])));
    }, {});

    const channelDef = function channelDef(type, i) {
        return {
            back: {
    ...
    const createEnumeratedControl = function createEnumeratedControl(array, one) {
        return array.reduce(function(arr, i) {
            const def = one(i);
            const control = Object.keys(def).reduce(function(obj, key) {
    ...
    const createChannelControl = function createChannelControl(i) {
        const _ref = i < 5 ? ["Channel", i] : ["Sampler", i - 4],
            _ref2 = _slicedToArray(_ref, 2),
            name = _ref2[0],
            number = _ref2[1];

        const channelDefInstance = channelDef(name, number);
        const channel = Object.keys(channelDefInstance).filter(function(key) {
    ...
    const channelControls = range(8).map(function(i) {
    ...
    const sanitize = function sanitize(name) {
        return name.replace(".", "$dot$").replace("[", "$sbs$")
            .replace("]", "$sbe$");
    };

    const ControlBus = /*#__PURE__*/function() {
        ...
        _createClass$1(ControlBus, [{
            ...
            value: function connect(id, control, cb) {
                ...
                const group = control.group,
                    name = control.name;
                const key = "".concat(sanitize(group), "_").concat(sanitize(name));
                const engineCb = "".concat(callbackPrefix, "_").concat(key);
                ...
                if (!this._registry[engineCb]) {
                    this._registry[engineCb] = function(value) {
                        for (const _id in _this._callbackList[key]) {
        ...
        _createClass$1(Timer, [{
            ...
            value: function start(interval) {
                if (this._state == null) {
                    ...
                    const key = "".concat(timerPrefix, "_").concat(started, "_")
                        .concat(parseInt(Math.random() * 100));
                    const handle = engine_1.beginTimer(interval, "".concat(this._registryName, ".").concat(key));
                    this._state = {
                        handle: handle,
                        key: key,
                        started: started
    ...
    const makeTimer = function makeTimer(moduleName, registry) {
    ...
    const stringify_1 = createCommonjsModule(function(module, exports) {
    ...
    const stringify_2 = stringify_1.getSerialize;
     ...
     * @param Derived
     */
    function _createSuper(Derived) { return function() { let Super = _getPrototypeOf(Derived), result; if (_isNativeReflectConstruct()) { const NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }

    /**
     *
     */
    function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) { return false; } if (Reflect.construct.sham) { return false; } if (typeof Proxy === "function") { return true; } try { Date.prototype.toString.call(Reflect.construct(Date, [], function() {})); return true; } catch (e) { return false; } }
    const callbackPrefix$1 = "__midi";

    const leftPad = function leftPad(str, padString, length) {
        let buf = str;
    ...
    const hexFormat = function hexFormat(n, d) {
        return "0x" + leftPad(n.toString(16).toUpperCase(), "0", d);
    };

    const MidiBus = /*#__PURE__*/function(_EventEmitter) {
        _inherits(MidiBus, _EventEmitter);

        const _super = _createSuper(MidiBus);
        ...
        function MidiBus(registry, device) {
            ...
            Object.keys(device.buttons).forEach(function(buttonName) {
                ...
                _this.registry["".concat(callbackPrefix$1, "_").concat(hexFormat(def.status, 2), "_")
                    .concat(hexFormat(def.midino, 2))] = function(channel, control, value, status) {
                    const message = {
                        value: value,
                        button: button,
                        device: _this.device
     ...
     * @param Derived
     */
    function _createSuper$1(Derived) { return function() { let Super = _getPrototypeOf(Derived), result; if (_isNativeReflectConstruct$1()) { const NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
    ...
    const Component = /*#__PURE__*/function(_EventEmitter) {
        _inherits(Component, _EventEmitter);

        const _super = _createSuper$1(Component);
     ...
     * @param Derived
     */
    function _createSuper$2(Derived) { return function() { let Super = _getPrototypeOf(Derived), result; if (_isNativeReflectConstruct$2()) { const NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
    ...
    const MidiComponent = /*#__PURE__*/function(_Component) {
        _inherits(MidiComponent, _Component);

        const _super = _createSuper$2(MidiComponent);
     ...
     * @param Derived
     */
    function _createSuper$3(Derived) { return function() { let Super = _getPrototypeOf(Derived), result; if (_isNativeReflectConstruct$3()) { const NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
    ...
    const MidiButtonComponent = /*#__PURE__*/function(_MidiComponent) {
        _inherits(MidiButtonComponent, _MidiComponent);

        const _super = _createSuper$3(MidiButtonComponent);
     ...
     * @param Derived
     */
    function _createSuper$4(Derived) { return function() { let Super = _getPrototypeOf(Derived), result; if (_isNativeReflectConstruct$4()) { const NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
    ...
    const autoscrolled = function autoscrolled(binding) {
            ...
            binding.on("mount", function() {
                timer = timerBuilder(function() {
                    ...
                    if (interval > minInterval) {
                        const current = Date.now(); // silence Flow with unsafe casts
    ...
    const onScroll = function onScroll(control) {
        return function() {
            control.setValue(1);
        };
    };

    const onMidi = function onMidi(control) {
    ...
    const onMount = function onMount(_ref2) {
        const button = _ref2.button,
            device = _ref2.device;
        button.sendColor(device.colors.hi_yellow);
    };

    const onUnmount = function onUnmount(_ref3) {
        const button = _ref3.button,
            device = _ref3.device;
        button.sendColor(device.colors.black);
    };

    const PlaylistSidebar = /*#__PURE__*/function(_MidiComponent) {
        _inherits(PlaylistSidebar, _MidiComponent);

        const _super = _createSuper$4(PlaylistSidebar);
        ...
        function PlaylistSidebar(midibus, timerBuilder) {
            ...
            const btns = [new MidiButtonComponent(midibus, _this.device.buttons.vol), new MidiButtonComponent(midibus, _this.device.buttons.pan), new MidiButtonComponent(midibus, _this.device.buttons.snda), new MidiButtonComponent(midibus, _this.device.buttons.sndb), new MidiButtonComponent(midibus, _this.device.buttons.stop)];
     ...
     * @param Derived
     */
    function _createSuper$5(Derived) { return function() { let Super = _getPrototypeOf(Derived), result; if (_isNativeReflectConstruct$5()) { const NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
    ...
    const ModifierSidebar = /*#__PURE__*/function(_MidiComponent) {
        _inherits(ModifierSidebar, _MidiComponent);

        const _super = _createSuper$5(ModifierSidebar);
    ...
    const modes = function modes(ctx, n, c, s, cs) {
    ...
    const retainAttackMode = function retainAttackMode(modifier, cb) {
        let state = {
            shift: false,
            ctrl: false
        };
    ...
    /** Detect free variable `global` from Node.js. */
    const freeGlobal$1 = (typeof global === "undefined" ? "undefined" : _typeof(global)) == "object" && global && global.Object === Object && global;

    /** Detect free variable `self`. */

    const freeSelf$1 = (typeof self === "undefined" ? "undefined" : _typeof(self)) == "object" && self && self.Object === Object && self;
    /** Used as a reference to the global object. */
    ...
    const nativeObjectToString$2 = objectProto$9.toString;
    /** Built-in value references. */

    const symToStringTag$2 = _Symbol$1 ? _Symbol$1.toStringTag : undefined;
    /**
     * A specialized version of `baseGetTag` which ignores `Symbol.toStringTag` values.
     *
     * @private
    ...
    function getRawTag$1(value) {
        const isOwn = hasOwnProperty$7.call(value, symToStringTag$2),
    ...
    const nativeObjectToString$3 = objectProto$a.toString;
    /**
     * Converts `value` to a string using `Object.prototype.toString`.
     *
     * @private
    ...
    const symToStringTag$3 = _Symbol$1 ? _Symbol$1.toStringTag : undefined;
    /**
     * The base implementation of `getTag` without fallbacks for buggy environments.
     *
     * @private
    ...
    const asyncTag$1 = "[object AsyncFunction]",
    ...
    function isFunction$1(value) {
        ...
        const tag = baseGetTag$1(value);
        return tag == funcTag$2 || tag == genTag$1 || tag == asyncTag$1 || tag == proxyTag$1;
    }

    /** Used to detect overreaching core-js shims. */

    const coreJsData$1 = root$1["__core-js_shared__"];

    /** Used to detect methods masquerading as native. */

    const maskSrcKey$1 = function() {
    ...
    const reRegExpChar$1 = /[\\^$.*+?()[\]{}|]/g;
    /** Used to detect host constructors (Safari). */

    const reIsHostCtor$1 = /^\[object .+?Constructor\]$/;
    /** Used for built-in method references. */

    const funcProto$3 = Function.prototype,
        objectProto$b = Object.prototype;
    /** Used to resolve the decompiled source of functions. */

    const funcToString$3 = funcProto$3.toString;
    /** Used to check objects for own properties. */

    const hasOwnProperty$8 = objectProto$b.hasOwnProperty;
    /** Used to detect if a method is native. */

    const reIsNative$1 = RegExp("^" + funcToString$3.call(hasOwnProperty$8).replace(reRegExpChar$1, "\\$&")
        .replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
    /**
     * The base implementation of `_.isNative` without bad shim checks.
     *
    ...
    function baseIsNative$1(value) {
        ...
        const pattern = isFunction$1(value) ? reIsNative$1 : reIsHostCtor$1;
    ...
    function getNative$1(object, key) {
        const value = getValue$1(object, key);
        return baseIsNative$1(value) ? value : undefined;
    }

    const defineProperty$1 = function() {
        try {
            const func = getNative$1(Object, "defineProperty");
            func({}, "", {});
            return func;
        } catch (e) {}
    }();
    ...
    const hasOwnProperty$9 = objectProto$c.hasOwnProperty;
    /**
     * Assigns `value` to `key` of `object` if the existing value is not equivalent
     * using [`SameValueZero`](http://ecma-international.org/ecma-262/7.0/#sec-samevaluezero)
     * for equality comparisons.
    ...
    const baseSetToString$1 = !defineProperty$1 ? identity$1 : function(func, string) {
    ...
    /** Used to detect hot functions by number of calls within a span of milliseconds. */
    const HOT_COUNT$1 = 800,
        HOT_SPAN$1 = 16;
    /* Built-in method references for those with the same name as other `lodash` methods. */

    const nativeNow$1 = Date.now;
    /**
     * Creates a function that'll short out and invoke `identity` instead
     * of `func` when it's called `HOT_COUNT` or more times in `HOT_SPAN`
     * milliseconds.
    ...
    const setToString$1 = shortOut$1(baseSetToString$1);
    ...
    const objectProto$e = Object.prototype;
    /** Used to check objects for own properties. */

    const hasOwnProperty$a = objectProto$e.hasOwnProperty;
    /** Built-in value references. */

    const propertyIsEnumerable$1 = objectProto$e.propertyIsEnumerable;
    /**
     * Checks if `value` is likely an `arguments` object.
     *
     * @static
    ...
    const isArguments$1 = baseIsArguments$1(function() {
        return arguments;
    ...
    const freeExports$2 = (typeof exports === "undefined" ? "undefined" : _typeof(exports)) == "object" && exports && !exports.nodeType && exports;
    /** Detect free variable `module`. */

    const freeModule$2 = freeExports$2 && (typeof module === "undefined" ? "undefined" : _typeof(module)) == "object" && module && !module.nodeType && module;
    /** Detect the popular CommonJS extension `module.exports`. */

    const moduleExports$2 = freeModule$2 && freeModule$2.exports === freeExports$2;
    /** Built-in value references. */

    const Buffer$1 = moduleExports$2 ? root$1.Buffer : undefined;
    /* Built-in method references for those with the same name as other `lodash` methods. */

    const nativeIsBuffer$1 = Buffer$1 ? Buffer$1.isBuffer : undefined;
    /**
     * Checks if `value` is a buffer.
     *
     * @static
    ...
    const isBuffer$1 = nativeIsBuffer$1 || stubFalse$1;

    /** `Object#toString` result references. */

    const argsTag$3 = "[object Arguments]",
    ...
    const freeExports$3 = (typeof exports === "undefined" ? "undefined" : _typeof(exports)) == "object" && exports && !exports.nodeType && exports;
    /** Detect free variable `module`. */

    const freeModule$3 = freeExports$3 && (typeof module === "undefined" ? "undefined" : _typeof(module)) == "object" && module && !module.nodeType && module;
    /** Detect the popular CommonJS extension `module.exports`. */

    const moduleExports$3 = freeModule$3 && freeModule$3.exports === freeExports$3;
    /** Detect free variable `process` from Node.js. */

    const freeProcess$1 = moduleExports$3 && freeGlobal$1.process;
    /** Used to access faster Node.js helpers. */

    const nodeUtil$1 = function() {
        try {
            // Use `util.types` for Node.js 10+.
            const types = freeModule$3 && freeModule$3.require && freeModule$3.require("util").types;
    ...
    const nodeIsTypedArray$1 = nodeUtil$1 && nodeUtil$1.isTypedArray;
    /**
     * Checks if `value` is classified as a typed array.
     *
     * @static
    ...
    const isTypedArray$1 = nodeIsTypedArray$1 ? baseUnary$1(nodeIsTypedArray$1) : baseIsTypedArray$1;

    /** Used for built-in method references. */

    const objectProto$f = Object.prototype;
    /** Used to check objects for own properties. */

    const hasOwnProperty$b = objectProto$f.hasOwnProperty;
    /**
     * Creates an array of the enumerable property names of the array-like `value`.
     *
     * @private
    ...
    const nativeKeys$1 = overArg$1(Object.keys, Object);

    /** Used for built-in method references. */

    const objectProto$g = Object.prototype;
    /** Used to check objects for own properties. */

    const hasOwnProperty$c = objectProto$g.hasOwnProperty;
    /**
     * The base implementation of `_.keys` which doesn't treat sparse arrays as dense.
     *
     * @private
    ...
    const objectProto$h = Object.prototype;
    /** Used to check objects for own properties. */

    const hasOwnProperty$d = objectProto$h.hasOwnProperty;
    /**
     * Assigns own enumerable string keyed properties of source objects to the
     * destination object. Source objects are applied from left to right.
     * Subsequent sources overwrite property assignments of previous sources.
    ...
    const assign$1 = createAssigner$1(function(object, source) {
    ...
    const Map = getNative$1(root$1, "Map");

    /* Built-in method references that are verified to be native. */

    const nativeCreate = getNative$1(Object, "create");
    ...
    const objectProto$i = Object.prototype;
    /** Used to check objects for own properties. */

    const hasOwnProperty$e = objectProto$i.hasOwnProperty;
    /**
    ...
    const objectProto$j = Object.prototype;
    /** Used to check objects for own properties. */

    const hasOwnProperty$f = objectProto$j.hasOwnProperty;
    /**
    ...
    const Uint8Array = root$1.Uint8Array;
    ...
    const boolTag$2 = "[object Boolean]",
    ...
    const symbolProto = _Symbol$1 ? _Symbol$1.prototype : undefined,
    ...
    const objectProto$k = Object.prototype;
    /** Built-in value references. */

    const propertyIsEnumerable$2 = objectProto$k.propertyIsEnumerable;
    /* Built-in method references for those with the same name as other `lodash` methods. */
    ...
    const objectProto$l = Object.prototype;
    /** Used to check objects for own properties. */

    const hasOwnProperty$g = objectProto$l.hasOwnProperty;
    /**
    ...
    const DataView = getNative$1(root$1, "DataView");

    /* Built-in method references that are verified to be native. */

    const Promise = getNative$1(root$1, "Promise");

    /* Built-in method references that are verified to be native. */

    const Set = getNative$1(root$1, "Set");

    /* Built-in method references that are verified to be native. */

    const WeakMap = getNative$1(root$1, "WeakMap");
    ...
    const dataViewTag$3 = "[object DataView]";
    /** Used to detect maps, sets, and weakmaps. */

    const dataViewCtorString = toSource$1(DataView),
    ...
    let getTag = baseGetTag$1; // Fallback for data views, maps, sets, and weak maps in IE 11 and promises in Node.js < 6.
    ...
    if (DataView && getTag(new DataView(new ArrayBuffer(1))) != dataViewTag$3 || Map && getTag(new Map()) != mapTag$3 || Promise && getTag(Promise.resolve()) != promiseTag || Set && getTag(new Set()) != setTag$3 || WeakMap && getTag(new WeakMap()) != weakMapTag$2) {
        getTag = function getTag(value) {
            const result = baseGetTag$1(value),
    ...
    const argsTag$4 = "[object Arguments]",
        arrayTag$2 = "[object Array]",
        objectTag$3 = "[object Object]";
    /** Used for built-in method references. */

    const objectProto$m = Object.prototype;
    /** Used to check objects for own properties. */

    const hasOwnProperty$h = objectProto$m.hasOwnProperty;
    /**
    ...
    function baseIsEqualDeep(object, other, bitmask, customizer, equalFunc, stack) {
        ...
        if (!(bitmask & COMPARE_PARTIAL_FLAG$3)) {
            const objIsWrapped = objIsObj && hasOwnProperty$h.call(object, "__wrapped__"),
    ...
    const COMPARE_PARTIAL_FLAG$4 = 1,
    ...
    const symbolProto$1 = _Symbol$1 ? _Symbol$1.prototype : undefined,
    ...
    const COMPARE_PARTIAL_FLAG$5 = 1,
    ...
    const play = (function(gridPosition) {
    ...
    const sync = (function(gridPosition) {
        return function(deck) {
            return function(modifier) {
                return function(device) {
                    return {
    ...
    const nudge = (function(gridPosition) {
        return function(deck) {
            return function(modifier) {
                return function(device) {
                    const rateEpsilon = 1e-3;

                    const getDirection = function getDirection(rate) {
                        if (rate < -rateEpsilon) {
                            return "up";
                    ...
                    const onNudgeMidi = function onNudgeMidi(dir) {
                        return function(modifier) {
                    ...
                    const onRate = function onRate(_ref3, _ref4) {
    ...
    const cue = (function(gridPosition) {
        return function(deck) {
            return function(modifier) {
                return function(device) {
                    return {
     ...
     * @param Derived
     */
    function _createSuper$6(Derived) { return function() { let Super = _getPrototypeOf(Derived), result; if (_isNativeReflectConstruct$6()) { const NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
    ...
    const Bpm = /*#__PURE__*/function(_EventEmitter) {
        _inherits(Bpm, _EventEmitter);

        const _super = _createSuper$6(Bpm);
    ...
    const tap = (function(gridPosition) {
        return function(deck) {
            return function(modifier) {
                return function(device) {
    ...
    const grid = (function(gridPosition) {
        return function(deck) {
            return function(modifier) {
                return function(device) {
                    const onGrid = function onGrid(dir) {
    ...
    const pfl = (function(gridPosition) {
        return function(deck) {
            return function(modifier) {
                return function(device) {
                    return function(device) {
    ...
    const quantize = (function(gridPosition) {
        return function(deck) {
            return function(modifier) {
                return function(device) {
                    return {
    ...
    const keyshift = (function(shifts, d) {
            ...
            return function(deck) {
                return function(modifier) {
                    return function(device) {
                        ...
                        const temporaryChange = function temporaryChange(i, value, bindings, state) {
                            if (value) {
                        ...
                        const onMidi = function onMidi(i) {
                            return function(modifier) {
                                return retainAttackMode(modifier, function(mode, _ref, _ref2) {
                                    const value = _ref.value;
                                    const bindings = _ref2.bindings,
                                    ...
                                    modes(mode, function() {
                                        ...
                                        if (value) {
                                            if (state.set === 0) {
                                                ...
                                                for (let _i2 = 0; _i2 < shifts.length; ++_i2) {
    ...
    const range$1 = createRange$1();

    const hotcue = (function(n, d) {
        const s = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
        return function(gridPosition) {
            return function(deck) {
                return function(modifier) {
                    return function(device) {
                        const onHotcueMidi = function onHotcueMidi(i) {
                            return function(_ref, _ref2) {
                                const value = _ref.value;
                                const bindings = _ref2.bindings;
                                modes(modifier.getState(), function() {
                        ...
                        const onHotcueEnabled = function onHotcueEnabled(i) {
                            return function(_ref3, _ref4) {
                                const value = _ref3.value;
                                const bindings = _ref4.bindings;
    ...
    const load = (function(gridPosition) {
        return function(deck) {
            return function(modifier) {
                return function(device) {
                    const onStateChanged = function onStateChanged(loaded, playing, bindings) {
                        if (loaded && playing) {
    ...
    const key = (function(gridPosition) {
        return function(deck) {
            return function(modifier) {
                return function(device) {
                    return {
    ...
    const spreadableSymbol = _Symbol$1 ? _Symbol$1.isConcatSpreadable : undefined;
    /**
    ...
    const beatjump = (function(jumps, vertical) {
        return function(gridPosition) {
            return function(deck) {
                return function(modifier) {
                    return function(device) {
                        ...
                        const onMidi = function onMidi(k, j, d) {
                            return function(modifier) {
                                return retainAttackMode(modifier, function(mode, _ref, _ref2) {
                                    const value = _ref.value;
                                    const bindings = _ref2.bindings,
                        ...
                        const onMount = function onMount(k) {
    ...
    const beatloop = (function(loops, d) {
        return function(gridPosition) {
            return function(deck) {
                return function(modifier) {
                    return function(device) {
                        ...
                        const onAttack = function onAttack(l) {
                            return function(modifier) {
                                return function() {
                                    modes(modifier.getState(), function() {
                        ...
                        const onUpdate = function onUpdate(i) {
                            return function(_ref, _ref2) {
                                const value = _ref.value;
                                const bindings = _ref2.bindings;
    ...
    const loopjump = function loopjump(jumps) {
        return function(gridPosition) {
            return function(deck) {
                return function(modifier) {
                    return function(device) {
    ...
    const loopjumpSmall = function loopjumpSmall(amount) {
        return function(button) {
            return function(deck) {
                return function(modifier) {
                    return function(device) {
                        const onAttack = function onAttack(dir) {
                            return function() {
                                modes(modifier.getState(), function() {
    ...
    const loopMultiply = (function(gridPosition) {
        return function(deck) {
            return function(_) {
                return function(device) {
                    const onMount = function onMount(k) {
                    ...
                    const onAttack = function onAttack(k) {
                        return function() {
    ...
    const reloop = (function(gridPosition) {
        return function(deck) {
            return function(modifier) {
                return function(device) {
                    return {
    ...
    const loopIo = (function(gridPosition) {
        return function(deck) {
            return function(modifier) {
                return function(device) {
                    const loopName = {
                    ...
                    const onMidi = function onMidi(dir) {
                        return function(_ref, _ref2) {
                            const value = _ref.value;
                            const bindings = _ref2.bindings;
                            modes(modifier.getState(), function() {
    ...
    const slip = (function(gridPosition) {
        return function(deck) {
            return function(modifier) {
                return function(device) {
                    const onMidi = function onMidi(modifier) {
                        return retainAttackMode(modifier, function(mode, _ref, _ref2) {
                            const value = _ref.value;
                            const bindings = _ref2.bindings,
                                state = _ref2.state;
     ...
     * @param Derived
     */
    function _createSuper$7(Derived) { return function() { let Super = _getPrototypeOf(Derived), result; if (_isNativeReflectConstruct$7()) { const NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }

    /**
     *
     */
    function _isNativeReflectConstruct$7() { if (typeof Reflect === "undefined" || !Reflect.construct) { return false; } if (Reflect.construct.sham) { return false; } if (typeof Proxy === "function") { return true; } try { Date.prototype.toString.call(Reflect.construct(Date, [], function() {})); return true; } catch (e) { return false; } }
    const makePresetFromPartialTemplate = function makePresetFromPartialTemplate(id, partialTemplate, offset) {
        return function(deck) {
    ...
    var Preset = /*#__PURE__*/function(_MidiComponent) {
        ...
        const _super = _createSuper$7(Preset);

        /**
         * @param midibus
         * @param controlComponentBuilder
         * @param modifier
         * @param id
         * @param template
         * @param offset
                    ...
                    Object.keys(bindings).forEach(function(bk) {
                        if (bindings[bk]) {
                            ...
                            if (binding.type === "control") {
                                const name = "".concat(binding.target.def.group).concat(binding.target.def.name);

                                if (!controlBindings[name]) {
                                    controlBindings[name] = controlComponentBuilder("".concat(id, ".").concat(tk, ".")
                                        .concat(bk))(binding.target);
                                }
                                ...
                                const _name = nameOf(position[0], position[1]);
        ...
        _createClass$1(Preset, [{
            key: "onMount",
            value: function onMount() {
                const _this$preset = this.preset,
            ...
            key: "onUnmount",
            value: function onUnmount() {
                const _this$preset2 = this.preset,
     ...
     * @param Derived
     */
    function _createSuper$8(Derived) { return function() { let Super = _getPrototypeOf(Derived), result; if (_isNativeReflectConstruct$8()) { const NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
    ...
    const onMidi$1 = function onMidi(selectorBar, channel, modifier) {
    ...
    const SelectorBar = /*#__PURE__*/function(_MidiComponent) {
        _inherits(SelectorBar, _MidiComponent);

        const _super = _createSuper$8(SelectorBar);
        ...
        function SelectorBar(midibus, controlComponentBuilder, modifier, id) {
            ...
            _this.bindings = SelectorBar.buttons.map(function(v, i) {
                const binding = new MidiButtonComponent(_this.midibus, _this.device.buttons[v]);
        ...
        _createClass$1(SelectorBar, [{
            ...
            value: function removeChord() {
                ...
                this.chord.forEach(function(ch) {
                    const found = findIndex(layout, function(b) {
                        return b.channel === ch;
                    });
            ...
            value: function addToChord(channel) {
                if (this.chord.length === 4) {
                    ...
                    const found = findIndex(this.layout, function(b) {
    ...
    const Layout = /*#__PURE__*/function(_MidiComponent2) {
        _inherits(Layout, _MidiComponent2);

        const _super2 = _createSuper$8(Layout);
    ...
    const blockEquals = function blockEquals(a, b) {
    ...
    var reorganize = function reorganize(current, selectedChannels) {
        ...
        return current.reduce(function(diff, block) {
            const _diff = _slicedToArray(diff, 2),
                neg = _diff[0],
                pos = _diff[1];

            const matched = findIndex(pos, function(b) {
    ...
    const posMod = function posMod(x, n) {
        return (x % n + n) % n;
    };

    var cycle = function cycle(channel, current, dir) {
        const matched = findIndex(current, function(block) {
     ...
     * @param Derived
     */
    function _createSuper$9(Derived) { return function() { let Super = _getPrototypeOf(Derived), result; if (_isNativeReflectConstruct$9()) { const NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
    ...
    const Screen = /*#__PURE__*/function(_MidiComponent) {
        _inherits(Screen, _MidiComponent);

        const _super = _createSuper$9(Screen);
     ...
     * @param Derived
     */
    function _createSuper$a(Derived) { return function() { let Super = _getPrototypeOf(Derived), result; if (_isNativeReflectConstruct$a()) { const NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }

    /**
     *
     */
    function _isNativeReflectConstruct$a() { if (typeof Reflect === "undefined" || !Reflect.construct) { return false; } if (Reflect.construct.sham) { return false; } if (typeof Proxy === "function") { return true; } try { Date.prototype.toString.call(Reflect.construct(Date, [], function() {})); return true; } catch (e) { return false; } }
    const makeControlComponent = function makeControlComponent(controlBus) {
        return function(id) {
    ...
    var ControlComponent = /*#__PURE__*/function(_Component) {
        ...
        const _super = _createSuper$a(ControlComponent);
     ...
     * @param Derived
     */
    function _createSuper$b(Derived) { return function() { let Super = _getPrototypeOf(Derived), result; if (_isNativeReflectConstruct$b()) { const NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }

    /**
     *
     */
    function _isNativeReflectConstruct$b() { if (typeof Reflect === "undefined" || !Reflect.construct) { return false; } if (Reflect.construct.sham) { return false; } if (typeof Proxy === "function") { return true; } try { Date.prototype.toString.call(Reflect.construct(Date, [], function() {})); return true; } catch (e) { return false; } }
    const LaunchpadMidiButton = /*#__PURE__*/function() {
        /**
         * @param def
         */
    ...
    const Global = /*#__PURE__*/function(_Component) {
        _inherits(Global, _Component);

        const _super = _createSuper$b(Global);
        ...
        function Global(name, device) {
            ...
            _this.name = name;
            _this.device = device;
            const timerBuilder = makeTimer(name, _assertThisInitialized(_this));
            const controlComponentBuilder = makeControlComponent(ControlBus.create(name, _assertThisInitialized(_this)));
            const midibus = MidiBus.create(_assertThisInitialized(_this), device);
    ...
    /** Detect free variable `global` from Node.js. */
    const freeGlobal$2 = (typeof global === "undefined" ? "undefined" : _typeof$1(global)) == "object" && global && global.Object === Object && global;

    /** Detect free variable `self`. */

    const freeSelf$2 = (typeof self === "undefined" ? "undefined" : _typeof$1(self)) == "object" && self && self.Object === Object && self;
    /** Used as a reference to the global object. */
    ...
    const _Symbol$2 = root$2.Symbol;

    /** Used for built-in method references. */

    const objectProto$n = Object.prototype;
    /** Used to check objects for own properties. */

    const hasOwnProperty$i = objectProto$n.hasOwnProperty;
    /**
     * Used to resolve the
     * [`toStringTag`](http://ecma-international.org/ecma-262/7.0/#sec-object.prototype.tostring)
     * of values.
    ...
    const nativeObjectToString$4 = objectProto$n.toString;
    /** Built-in value references. */

    const symToStringTag$4 = _Symbol$2 ? _Symbol$2.toStringTag : undefined;
    /**
     * A specialized version of `baseGetTag` which ignores `Symbol.toStringTag` values.
     *
     * @private
    ...
    function getRawTag$2(value) {
        const isOwn = hasOwnProperty$i.call(value, symToStringTag$4),
        ...
        const result = nativeObjectToString$4.call(value);
    ...
    /** Used for built-in method references. */
    const objectProto$o = Object.prototype;
    /**
     * Used to resolve the
     * [`toStringTag`](http://ecma-international.org/ecma-262/7.0/#sec-object.prototype.tostring)
     * of values.
    ...
    const nativeObjectToString$5 = objectProto$o.toString;
    /**
     * Converts `value` to a string using `Object.prototype.toString`.
     *
     * @private
    ...
    const symToStringTag$5 = _Symbol$2 ? _Symbol$2.toStringTag : undefined;
    /**
     * The base implementation of `getTag` without fallbacks for buggy environments.
     *
     * @private
    ...
    const asyncTag$2 = "[object AsyncFunction]",
    ...
    function isFunction$2(value) {
        ...
        const tag = baseGetTag$2(value);
        return tag == funcTag$4 || tag == genTag$2 || tag == asyncTag$2 || tag == proxyTag$2;
    }

    /** Used to detect overreaching core-js shims. */

    const coreJsData$2 = root$2["__core-js_shared__"];

    /** Used to detect methods masquerading as native. */

    const maskSrcKey$2 = function() {
        const uid = /[^.]+$/.exec(coreJsData$2 && coreJsData$2.keys && coreJsData$2.keys.IE_PROTO || "");
        return uid ? "Symbol(src)_1." + uid : "";
    }();
    /**
     * Checks if `func` has its source masked.
    ...
    /** Used for built-in method references. */
    const funcProto$4 = Function.prototype;
    /** Used to resolve the decompiled source of functions. */

    const funcToString$4 = funcProto$4.toString;
    /**
     * Converts `func` to its source code.
     *
     * @private
    ...
    const reRegExpChar$2 = /[\\^$.*+?()[\]{}|]/g;
    /** Used to detect host constructors (Safari). */

    const reIsHostCtor$2 = /^\[object .+?Constructor\]$/;
    /** Used for built-in method references. */

    const funcProto$5 = Function.prototype,
        objectProto$p = Object.prototype;
    /** Used to resolve the decompiled source of functions. */

    const funcToString$5 = funcProto$5.toString;
    /** Used to check objects for own properties. */

    const hasOwnProperty$j = objectProto$p.hasOwnProperty;
    /** Used to detect if a method is native. */

    const reIsNative$2 = RegExp("^" + funcToString$5.call(hasOwnProperty$j).replace(reRegExpChar$2, "\\$&")
        .replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
    /**
     * The base implementation of `_.isNative` without bad shim checks.
     *
    ...
    function baseIsNative$2(value) {
        ...
        const pattern = isFunction$2(value) ? reIsNative$2 : reIsHostCtor$2;
    ...
    function getNative$2(object, key) {
        const value = getValue$2(object, key);
        return baseIsNative$2(value) ? value : undefined;
    }

    const defineProperty$2 = function() {
        try {
            const func = getNative$2(Object, "defineProperty");
            func({}, "", {});
            return func;
        } catch (e) {}
    }();
    ...
    const objectProto$q = Object.prototype;
    /** Used to check objects for own properties. */

    const hasOwnProperty$k = objectProto$q.hasOwnProperty;
    /**
     * Assigns `value` to `key` of `object` if the existing value is not equivalent
     * using [`SameValueZero`](http://ecma-international.org/ecma-262/7.0/#sec-samevaluezero)
     * for equality comparisons.
    ...
    const baseSetToString$2 = !defineProperty$2 ? identity$2 : function(func, string) {
    ...
    /** Used to detect hot functions by number of calls within a span of milliseconds. */
    const HOT_COUNT$2 = 800,
        HOT_SPAN$2 = 16;
    /* Built-in method references for those with the same name as other `lodash` methods. */

    const nativeNow$2 = Date.now;
    /**
     * Creates a function that'll short out and invoke `identity` instead
     * of `func` when it's called `HOT_COUNT` or more times in `HOT_SPAN`
     * milliseconds.
    ...
    const setToString$2 = shortOut$2(baseSetToString$2);
    ...
    /** Used as references for various `Number` constants. */
    const MAX_SAFE_INTEGER$5 = 9007199254740991;
    /** Used to detect unsigned integer values. */

    const reIsUint$2 = /^(?:0|[1-9]\d*)$/;
    /**
     * Checks if `value` is a valid array-like index.
     *
     * @private
    ...
    /** Used for built-in method references. */
    const objectProto$r = Object.prototype;
    /**
     * Checks if `value` is likely a prototype object.
     *
     * @private
    ...
    const argsTag$5 = "[object Arguments]";
    /**
     * The base implementation of `_.isArguments`.
     *
     * @private
    ...
    const objectProto$s = Object.prototype;
    /** Used to check objects for own properties. */

    const hasOwnProperty$l = objectProto$s.hasOwnProperty;
    /** Built-in value references. */

    const propertyIsEnumerable$3 = objectProto$s.propertyIsEnumerable;
    /**
     * Checks if `value` is likely an `arguments` object.
     *
     * @static
    ...
    const isArguments$2 = baseIsArguments$2(function() {
        return arguments;
    ...
    const freeExports$4 = (typeof exports === "undefined" ? "undefined" : _typeof$1(exports)) == "object" && exports && !exports.nodeType && exports;
    /** Detect free variable `module`. */

    const freeModule$4 = freeExports$4 && (typeof module === "undefined" ? "undefined" : _typeof$1(module)) == "object" && module && !module.nodeType && module;
    /** Detect the popular CommonJS extension `module.exports`. */

    const moduleExports$4 = freeModule$4 && freeModule$4.exports === freeExports$4;
    /** Built-in value references. */

    const Buffer$2 = moduleExports$4 ? root$2.Buffer : undefined;
    /* Built-in method references for those with the same name as other `lodash` methods. */

    const nativeIsBuffer$2 = Buffer$2 ? Buffer$2.isBuffer : undefined;
    /**
     * Checks if `value` is a buffer.
     *
     * @static
    ...
    const isBuffer$2 = nativeIsBuffer$2 || stubFalse$2;

    /** `Object#toString` result references. */

    const argsTag$6 = "[object Arguments]",
    ...
    const arrayBufferTag$3 = "[object ArrayBuffer]",
    ...
    const freeExports$5 = (typeof exports === "undefined" ? "undefined" : _typeof$1(exports)) == "object" && exports && !exports.nodeType && exports;
    /** Detect free variable `module`. */

    const freeModule$5 = freeExports$5 && (typeof module === "undefined" ? "undefined" : _typeof$1(module)) == "object" && module && !module.nodeType && module;
    /** Detect the popular CommonJS extension `module.exports`. */

    const moduleExports$5 = freeModule$5 && freeModule$5.exports === freeExports$5;
    /** Detect free variable `process` from Node.js. */

    const freeProcess$2 = moduleExports$5 && freeGlobal$2.process;
    /** Used to access faster Node.js helpers. */

    const nodeUtil$2 = function() {
        try {
            // Use `util.types` for Node.js 10+.
            const types = freeModule$5 && freeModule$5.require && freeModule$5.require("util").types;
    ...
    const nodeIsTypedArray$2 = nodeUtil$2 && nodeUtil$2.isTypedArray;
    /**
     * Checks if `value` is classified as a typed array.
     *
     * @static
    ...
    const isTypedArray$2 = nodeIsTypedArray$2 ? baseUnary$2(nodeIsTypedArray$2) : baseIsTypedArray$2;

    /** Used for built-in method references. */

    const objectProto$t = Object.prototype;
    /** Used to check objects for own properties. */

    const hasOwnProperty$m = objectProto$t.hasOwnProperty;
    /**
     * Creates an array of the enumerable property names of the array-like `value`.
     *
     * @private
    ...
    const nativeKeys$2 = overArg$2(Object.keys, Object);

    /** Used for built-in method references. */

    const objectProto$u = Object.prototype;
    /** Used to check objects for own properties. */

    const hasOwnProperty$n = objectProto$u.hasOwnProperty;
    /**
     * The base implementation of `_.keys` which doesn't treat sparse arrays as dense.
     *
     * @private
    ...
    const objectProto$v = Object.prototype;
    /** Used to check objects for own properties. */

    const hasOwnProperty$o = objectProto$v.hasOwnProperty;
    /**
     * Assigns own enumerable string keyed properties of source objects to the
     * destination object. Source objects are applied from left to right.
     * Subsequent sources overwrite property assignments of previous sources.
    ...
    const assign$2 = createAssigner$2(function(object, source) {
    ...
    const name = "@mixxx-launchpad/mk1";
    const version = "1.0.0";
    const main = "src/index.js";
    const module$1 = "src/index.js";
    const dependencies = {
  	"@babel/runtime": "^7.3.1",
    ...
    const LaunchpadMK1Device = /*#__PURE__*/function() {
        /**
         *
         */
    ...
    const index = create(pkg.controller.global, new LaunchpadMK1Device());
