...
(function(global) {
     ...
     * @returns {Array} Array containing values
     * @private
     */
     ...
     * @returns {Array<number>} Array of MIDI addresses for the given range
     * @private
     */
     ...
     * @returns {Array<number>} Address range for the encoders in the encoder group
     * @private
     */
     ...
     * @returns {Array<number>} Address range for the encoders in the encoder row
     * @private
     */
     ...
     * @returns {Array<number>} Address range for the buttons in the button row
     * @private
     */
     ...
     *
     * @returns {Array<number>} Address range for the buttons in the button box
     * @private
     */
