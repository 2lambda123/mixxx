...
function PushKeyBin(colordef, colorpush, group, control, pushval) {
    const that = PushKey(colordef, colorpush);
 ...
 */
function ShiftKey() {
    const that = PushKey("lo_green", "hi_yellow");
...
function LoadKey(ctrl, channel) {
    const that = PushKey("hi_green", "hi_amber");
...
function ZoomKey(dir) {
    const that = PushKey("lo_green", "hi_amber");
