...
cdmp7000.playPositionChanged = function(channel, control, value, status, group) {
    ...
    const currentValue2 = engine.getValue(group, "playposition");
...
cdmp7000.LoadTrack = function(channel, control, value, status, group) {
    ...
    let currentBpm = engine.getValue(group, "bpm");
    let currentRange = engine.getValue(group, "rateRange");
    let currentDur = engine.getValue(group, "duration");
...
cdmp7000.rate_d1 = function(channel, control, value, status, group) {
    let pitchValue = engine.getValue(cdmp7000.firstDeckGroup, "rate");
    let currentBpm = engine.getValue(cdmp7000.firstDeckGroup, "bpm");
...
cdmp7000.rate_d2 = function(channel, control, value, status, group) {
    let pitchValue = engine.getValue(cdmp7000.secondDeckGroup, "rate");
    let currentBpm = engine.getValue(cdmp7000.secondDeckGroup, "bpm");
