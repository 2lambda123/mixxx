...
VestaxVCI1003DEX.loopLeds = function() {
    ...
    const looping = engine.getValue(active_deck, "loop_enabled");
    const startposition = engine.getValue(active_deck, "loop_start_position");
    const endposition = engine.getValue(active_deck, "loop_end_position");
...
VestaxVCI1003DEX.leftSyncLed = function(channel, control, value, status, group) {
    const activebeat=engine.getValue("[Channel1]", "beat_active");
...
VestaxVCI1003DEX.rightSyncLed = function(channel, control, value, status, group) {
    const activebeat=engine.getValue("[Channel2]", "beat_active");
...
VestaxVCI1003DEX.jog_wheel1 = function(channel, control, value, status, group) {
    // 41 > 7F: CW Slow > Fast ???
    // 3F > 0 : CCW Slow > Fast ???
    const jogValue = value - 0x40; // -64 to +63, - = CCW, + = CW
...
VestaxVCI1003DEX.pfl1 = function(channel, control, value, status, group) {
    ...
    const currentlyPfling = engine.getValue("[Channel1]", "pfl");
...
VestaxVCI1003DEX.pfl2 = function(channel, control, value, status, group) {
    ...
    const currentlyPfling = engine.getValue("[Channel2]", "pfl");
    if (currentlyPfling == 1 && value == 0x7F) {    // If currently Pfling
...
VestaxVCI1003DEX.flanger1 = function(channel, control, value, status, group) {
    ...
    const currentlyFlanging = engine.getValue("[Channel1]", "flanger");
...
VestaxVCI1003DEX.flanger2 = function(channel, control, value, status, group) {
    ...
    const currentlyFlanging = engine.getValue("[Channel2]", "flanger");
    if (currentlyFlanging == 1 && value == 0x7F) {    // If currently Flanging
...
VestaxVCI1003DEX.keylock1 = function(channel, control, value, status, group) {
    ...
    if (value == 0x7F)      {
        const keylocked = engine.getValue("[Channel1]", "keylock");
        if (keylocked == 0) 	{
...
VestaxVCI1003DEX.keylock2 = function(channel, control, value, status, group) {
    ...
    if (value == 0x7F)      {
        const keylocked = engine.getValue("[Channel2]", "keylock");
        if (keylocked == 0) 	{
...
VestaxVCI1003DEX.reverse1 = function(channel, control, value, status, group) {
    ...
    if (value == 0x7F)      {
        const reversed = engine.getValue("[Channel1]", "reverse");
        if (reversed == 0) 	{
...
VestaxVCI1003DEX.reverse2 = function(channel, control, value, status, group) {
    ...
    if (value == 0x7F)      {
        const reversed = engine.getValue("[Channel2]", "reverse");
        if (reversed == 0) 	{
...
VestaxVCI1003DEX.cue1 = function(channel, control, value, status, group) {
    ...
    if (value == 0x7F)      {
        const localCurrentCue=currentCue1;
        const cue1 = engine.getValue("[Channel1]", "hotcue_1_enabled");
        const cue2 = engine.getValue("[Channel1]", "hotcue_2_enabled");
        const cue3 = engine.getValue("[Channel1]", "hotcue_3_enabled");
        const cue4 = engine.getValue("[Channel1]", "hotcue_4_enabled");
...
VestaxVCI1003DEX.cue2 = function(channel, control, value, status, group) {
    ...
    if (value == 0x7F)      {
        const localCurrentCue=currentCue2;
        const cue1 = engine.getValue("[Channel2]", "hotcue_1_enabled");
        const cue2 = engine.getValue("[Channel2]", "hotcue_2_enabled");
        const cue3 = engine.getValue("[Channel2]", "hotcue_3_enabled");
        const cue4 = engine.getValue("[Channel2]", "hotcue_4_enabled");
...
VestaxVCI1003DEX.sampler1play = function(channel, control, value, status, group) {
    ...
    const currentlyPlaying = engine.getValue("[Sampler1]", "play");
    if (currentlyPlaying == 1 && value == 0x7F) {    // If currently playing
...
VestaxVCI1003DEX.sampler2play = function(channel, control, value, status, group) {
    ...
    const currentlyPlaying = engine.getValue("[Sampler2]", "play");
    if (currentlyPlaying == 1 && value == 0x7F) {    // If currently playing
...
VestaxVCI1003DEX.sampler3play = function(channel, control, value, status, group) {
    ...
    const currentlyPlaying = engine.getValue("[Sampler3]", "play");
    if (currentlyPlaying == 1 && value == 0x7F) {    // If currently playing
