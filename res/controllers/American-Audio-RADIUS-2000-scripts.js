...
RADIUS2000.currentDeck2 = function(group) {
    if (group == "[Channel1]") { return "[Channel1]"; } else if (group == "[Channel2]") { return "[Channel2]"; }
...
RADIUS2000.play = function(channel, control, value, status, group) {
    const currentlyPlaying = engine.getValue(RADIUS2000.currentDeck2(group), "play");
...
RADIUS2000.keylock = function(channel, control, value, status, group) {
    const keylockStat = engine.getValue(RADIUS2000.currentDeck2(group), "keylock");
...
RADIUS2000.pitchRateRange = function(channel, control, value, status, group) {
    const pitchRateRange = engine.getValue(RADIUS2000.currentDeck2(group), "rateRange");
    if (value == 0x7F) {
...
RADIUS2000.pitchRate = function(channel, control, value, status, group) {
    const pitchRate = engine.getValue(RADIUS2000.currentDeck2(group), "rateRange");
...
RADIUS2000.flanger = function(channel, control, value, status, group) {
    const flangerFX = engine.getValue(RADIUS2000.currentDeck2(group), "flanger");
...
RADIUS2000.flangerDelay = function(channel, control, value, status, group) {
    const delayLevel = engine.getValue(RADIUS2000.currentDeck2(group), "lfoDelay");
    if (value == 0x41) {
