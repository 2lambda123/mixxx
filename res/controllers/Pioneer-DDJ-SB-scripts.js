...
PioneerDDJSB.deckToggleButton = function(channel, control, value, status, group) {
    let deckNumber = PioneerDDJSB.channelGroups[PioneerDDJSB.deckSwitchTable[group]] + 1;
...
PioneerDDJSB.tempoSliderLSB = function(channel, control, value, status, group) {
    const fullValue = (PioneerDDJSB.highResMSB[group].tempoSlider << 7) + value;
    engine.setValue(
...
PioneerDDJSB.gainKnobLSB = function(channel, control, value, status, group) {
    const fullValue = (PioneerDDJSB.highResMSB[group].gainKnob << 7) + value;
    engine.setValue(
        PioneerDDJSB.deckSwitchTable[group],
        "pregain",
...
PioneerDDJSB.filterHighKnobLSB = function(channel, control, value, status, group) {
    const fullValue = (PioneerDDJSB.highResMSB[group].filterHigh << 7) + value;
    engine.setValue(
        PioneerDDJSB.deckSwitchTable[group],
        "filterHigh",
        script.absoluteNonLin(fullValue, 0.0, 1.0, 4.0, 0, 0x3FFF)
...
PioneerDDJSB.filterMidKnobLSB = function(channel, control, value, status, group) {
    const fullValue = (PioneerDDJSB.highResMSB[group].filterMid << 7) + value;
    engine.setValue(
        PioneerDDJSB.deckSwitchTable[group],
        "filterMid",
        script.absoluteNonLin(fullValue, 0.0, 1.0, 4.0, 0, 0x3FFF))
...
PioneerDDJSB.filterLowKnobLSB = function(channel, control, value, status, group) {
    const fullValue = (PioneerDDJSB.highResMSB[group].filterLow << 7) + value;
    engine.setValue(
        PioneerDDJSB.deckSwitchTable[group],
        "filterLow",
        script.absoluteNonLin(fullValue, 0.0, 1.0, 4.0, 0, 0x3FFF)
...
PioneerDDJSB.deckFaderLSB = function(channel, control, value, status, group) {
    const fullValue = (PioneerDDJSB.highResMSB[group].deckFader << 7) + value;
...
PioneerDDJSB.filterKnobLSB = function(channel, control, value, status, group) {
    const fullValue = (PioneerDDJSB.highResMSB[group].filterKnob << 7) + value;
    if (PioneerDDJSB.shiftPressed) {
        engine.setValue(
            PioneerDDJSB.deckSwitchTable[group],
            "pregain",
...
PioneerDDJSB.hotCueButtons = function(channel, control, value, status, group) {
    const hotCueIndex = (control >= 0x40 ? control - 0x40 + 5 : control + 1);
...
PioneerDDJSB.clearHotCueButtons = function(channel, control, value, status, group) {
    const hotCueIndex = (control >= 0x48 ? control - 0x48 + 5 : control - 7);
    if (value) {
...
PioneerDDJSB.beatloopButtons = function(channel, control, value, status, group) {
    const index = (control <= 0x13 ? control - 0x10 : control - 0x14);
    if (value) {
        engine.setValue(
            PioneerDDJSB.deckSwitchTable[group],
...
PioneerDDJSB.beatloopRollButtons = function(channel, control, value, status, group) {
    const index = (control <= 0x53 ? control - 0x50 : control - 0x54);
    engine.setValue(
        PioneerDDJSB.deckSwitchTable[group],
...
PioneerDDJSB.fxLeds = function(value, group, control) {
    const deck = PioneerDDJSB.fxGroups[group],
...
PioneerDDJSB.slipLed = function(value, group, control) {
    const led = (PioneerDDJSB.invertVinylSlipButton ? PioneerDDJSB.nonPadLeds.vinyl : PioneerDDJSB.nonPadLeds.shiftVinyl);
...
PioneerDDJSB.samplerLeds = function(value, group, control) {
    let sampler = PioneerDDJSB.samplerGroups[group],
        channel;
...
PioneerDDJSB.jogPlatterTick = function(channel, control, value, status, group) {
    const deck = PioneerDDJSB.channelGroups[PioneerDDJSB.deckSwitchTable[group]];
...
PioneerDDJSB.triggerVinylLed = function(deck) {
    const led = (PioneerDDJSB.invertVinylSlipButton ? PioneerDDJSB.nonPadLeds.shiftVinyl : PioneerDDJSB.nonPadLeds.vinyl);
...
PioneerDDJSB.rotarySelector = function(channel, control, value, status) {
    const delta = PioneerDDJSB.getRotaryDelta(value);
...
PioneerDDJSB.softTakeoverEmulation = function(deck, index, currentValue) {
    const deltaToActive = currentValue - PioneerDDJSB.fxParamsActiveValues[deck][index];
